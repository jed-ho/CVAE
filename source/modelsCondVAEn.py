...
class Encoder(nn.Module):
    ...
    """
    def __init__(self, latent_dim, num_param, window_size, num_classes=2, sample_layer=GaussianSample):
        super(Encoder, self).__init__()
        self.num_param = num_param
        self.window_size = window_size
        self.input_dim = num_param * window_size
        hidden_dims = [1024, 512, 256, 128, 64, 32]  # Adjust these sizes as needed
...
class Decoder(nn.Module):
    ...
    def __init__(self, latent_dim, num_param, window_size, num_classes=2, scale_flag=0):
        ...
        self.num_param = num_param
        self.window_size = window_size
        hidden_dims = [32, 64, 128, 256, 512, 1024]  # Should mirror the encoder's hidden dimensions in reverse
...
class VAE(nn.Module):
    ...
    def __init__(self, latent_dim, num_param, window_size, num_classes=2, scale_flag=0):
        ...
        self.decoder = Decoder(self.z_dim, self.p_dim, self.t_dim, num_classes, self.scale_flag)
        self.kl_div = 0
